...
*
*@section 当前API
* @version Version 2.17.33.764(build: Sep 10 2018 16:14:49)
*
*
*@section 文档发布记录
...
*-# 2018-08-3(2.17.33)
*-# a.新增了一组@link #dvpLine 相机引脚@endlink操作相关的接口，建议别再使用dvpInputIo和dvpOutputIo系列的接口
*-# b.增加了@link #dvpSetTriggerSource 设置触发源@endlink的接口
*/
...
*@brief 获取相机触发源引脚的模式
*@param[in] handle 相机句柄
*@param[out] pTriggerLineMode 相机触发源引脚的模式
*@return 状态码
*@ingroup __DVP_TRIGGER__
*@see dvpSetTriggerLineMode
*/
dvp2api dvpStatus dvpGetTriggerLineMode(dvpHandle handle, dvpTriggerLineMode *pTriggerLineMode);


/**
*@brief 设置相机触发源引脚的模式
*@param[in] handle 相机句柄
*@param[in] TriggerLineMode 相机触发源引脚的模式
*@return 状态码
*@ingroup __DVP_TRIGGER__
*@see dvpGetTriggerLineMode
*/
dvp2api dvpStatus dvpSetTriggerLineMode(dvpHandle handle, dvpTriggerLineMode TriggerLineMode);
...
*@see dvpLoadDefault
*@see dvpSaveConfig
*@note 存档路径通常位于“C:/ProgramData/DO3THINK/DVP2”
*@warning 会覆盖当前设置，如有必要，请事先@link #dvpSaveConfig 备份当前设置@endlink到配置文件
*/
...
/** @defgroup __DVP_FORMAT__ 图像格式
*@{
*/
/** @} end of __DVP_FORMAT__ */
...
/** @defgroup __DVP_LINE__ 引脚功能
*@{
*/
/** @} end of __DVP_LINE__ */

/** @defgroup __DVP_CORRECTION__ 图像校正
*@{
*/
/** @} end of __DVP_CORRECTION__ */

/** @defgroup __DVP_PERFORMANCE__ 性能调节
*@{
*/
/** @} end of __DVP_PERFORMANCE__ */
